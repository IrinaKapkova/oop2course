public class Main {
    public static void main(String[] args) {
        ...
        Car audiA8 = new Car ("Audi", "A8", 3.0f, "черный", 2020, "Германии");
        System.out.println(audiA8);
        Car bmvZ8 = new Car("BMW", "Z8", 3.0f, "черный", 2021, "Германии");
        System.out.println(bmvZ8);
        Car kiaSportage4 = new Car("Kia", "Sportage 4-го поколения", 2.4f, "красный", 2018, "Южной Корее");
        System.out.println(kiaSportage4);
        Car hyundaiAvante = new Car("Hyundai", "Avante", 1.6f, "оранжевый", 2016, "Южной Корее");
